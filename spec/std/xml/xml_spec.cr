...
describe XML do
  ...
  it "handles errors" do
    ...
    errors.map{|e| {e.message, e.line_number, e.to_s} }.should eq [{"Opening and ending tag mismatch: people line 1 and foo", 1, "Opening and ending tag mismatch: people line 1 and foo"}]
  end
